...
{
    LedController::GetInstance()->changeRainbowLedsType(STATIC_RAINBOW, LedController::STRIP_INDEX);
    LedController::GetInstance()->changeRainbowLedsType(STATIC_RAINBOW, LedController::LAMP_INDEX);
}

static void dynamicRainbowFunc()
{
    LedController::GetInstance()->changeRainbowLedsType(DYNAMIC_RAINBOW, LedController::STRIP_INDEX);
    LedController::GetInstance()->changeRainbowLedsType(DYNAMIC_RAINBOW, LedController::LAMP_INDEX);
}

static void increaseSpeedFunc()
{
    LedController::GetInstance()->increaseRainbowSpeed(LedController::STRIP_INDEX);
    LedController::GetInstance()->increaseRainbowSpeed(LedController::LAMP_INDEX);
}

static void decreaseSpeedFunc()
{
    LedController::GetInstance()->decreaseRainbowSpeed(LedController::STRIP_INDEX);
    LedController::GetInstance()->decreaseRainbowSpeed(LedController::LAMP_INDEX);
}
...
{
    unsigned int newIndex = LedController::GetInstance()->getHueChangeDelayIndex(LedController::STRIP_INDEX) + 1u;
