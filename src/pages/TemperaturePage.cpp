...
{
    LedController::GetInstance()->setTemperatureRGB(255, 147, 41, LedController::STRIP_INDEX);
    LedController::GetInstance()->setTemperatureRGB(255, 147, 41, LedController::LAMP_INDEX);
}

static void color2ButtonFunc()
{
    LedController::GetInstance()->setTemperatureRGB(255, 187, 120, LedController::STRIP_INDEX);
    LedController::GetInstance()->setTemperatureRGB(255, 187, 120, LedController::LAMP_INDEX);
}

static void color3ButtonFunc()
{
    LedController::GetInstance()->setTemperatureRGB(255, 238, 227, LedController::STRIP_INDEX);
    LedController::GetInstance()->setTemperatureRGB(255, 238, 227, LedController::LAMP_INDEX);
}

static void color4ButtonFunc()
{
    LedController::GetInstance()->setTemperatureRGB(235, 238, 255, LedController::STRIP_INDEX);
    LedController::GetInstance()->setTemperatureRGB(235, 238, 255, LedController::LAMP_INDEX);
}

static void color5ButtonFunc()
{
    LedController::GetInstance()->setTemperatureRGB(214, 225, 255, LedController::STRIP_INDEX);
    LedController::GetInstance()->setTemperatureRGB(214, 225, 255, LedController::LAMP_INDEX);
}
...
TemperaturePage::TemperaturePage() : color1Button(BUTTONS_SPACE, BUTTONS_SPACE, BUTTONS_SIZE, BUTTONS_SIZE, "Candle"),
