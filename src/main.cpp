...
static SecondMenuPage secondMenuPage;
static TemperaturePage temperaturePage;
...
void setup()
{
  ...
  controller->addPage(SECOND_MENU_PAGE_ID, &secondMenuPage);
  controller->addPage(TEMPERATURE_PAGE_ID, &temperaturePage);
